  ...
  (function($) {
    ...
    return Chosen = (function(_super) {
      ...
      Chosen.prototype.set_up_html = function() {
        ...
        return this.form_field_jq[0].dispatchEvent(new CustomEvent("chosen:ready", {
          chosen: this
        }));
      };
      ...
      Chosen.prototype.results_show = function() {
        if (this.is_multiple && this.max_selected_options <= this.choices_count()) {
          this.form_field_jq[0].dispatchEvent(new CustomEvent("chosen:maxselected", {
            chosen: this
          }));
          return false;
        }
        ...
        this.search_field.val(this.search_field.val());
        this.winnow_results();
        return this.form_field_jq[0].dispatchEvent(new CustomEvent("chosen:showing_dropdown", {
          chosen: this
        }));
      };
      ...
      Chosen.prototype.results_hide = function() {
        if (this.results_showing) {
          ...
          this.form_field_jq[0].dispatchEvent(new CustomEvent("chosen:hiding_dropdown", {
            chosen: this
          }));
        }
      ...
      Chosen.prototype.results_reset = function() {
        ...
        this.form_field_jq[0].dispatchEvent(new Event("change"));
        if (this.active_field) {
      ...
      Chosen.prototype.result_select = function(evt) {
        ...
        if (this.result_highlight) {
          ...
          if (this.is_multiple || this.form_field.selectedIndex !== this.current_selectedIndex) {
            this.form_field_jq[0].dispatchEvent(new CustomEvent("change", {
      ...
      Chosen.prototype.no_results = function(terms) {
        ...
        return this.form_field_jq[0].dispatchEvent(new CustomEvent("chosen:no_results", {
          chosen: this
        }));
      };
