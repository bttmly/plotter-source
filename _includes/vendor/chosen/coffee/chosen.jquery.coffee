# CustomEvent constructor polyfill for IE 9+
do ->
...
do ( $ = jQuery ) ->
  ...
  class Chosen extends AbstractChosen
    ...
    set_up_html: ->
      ...
      @form_field_jq[0].dispatchEvent new CustomEvent "chosen:ready", chosen: this
    ...
    results_show: ->
      if @is_multiple and @max_selected_options <= this.choices_count()
        ...
        @form_field_jq[0].dispatchEvent new CustomEvent "chosen:maxselected", chosen: this
        return false
      ...
      @form_field_jq[0].dispatchEvent new CustomEvent "chosen:showing_dropdown", chosen: this
    ...
    results_hide: ->
      if @results_showing
        ...
        @form_field_jq[0].dispatchEvent new CustomEvent "chosen:hiding_dropdown", chosen: this
    ...
    results_reset: ->
      ...
      @form_field_jq[0].dispatchEvent new Event "change"
    ...
    result_select: (evt) ->
      if @result_highlight
        ...
        # @form_field_jq.trigger "change",
        @form_field_jq[0].dispatchEvent new CustomEvent "change", {'selected': @form_field.options[item.options_index].value} if @is_multiple || @form_field.selectedIndex != @current_selectedIndex
        @current_selectedIndex = @form_field.selectedIndex
        this.search_field_scale()
    ...
    result_deselect: (pos) ->
      ...
      if not @form_field.options[result_data.options_index].disabled
        ...
        @form_field_jq[0].dispatchEvent new CustomEvent "change", {deselected: @form_field.options[result_data.options_index].value}
        this.search_field_scale()
    ...
    no_results: (terms) ->
      ...
      @form_field_jq[0].dispatchEvent new CustomEvent "chosen:no_results", chosen:this
